...
<div class="mt-5 mb-20 inline-block min-w-full shadow-lg  border-2 rounded-lg p-6">
    ...
    <div class="lg:inline-block w-3/4 lg:w-2/4 align-top lg:ml-10">
        <!-- results pane  -->
                ...
                <div class="mt-2">
                    <fieldset class="inline-block border-2 border-slate-400  rounded-lg p-2 shadow-md"><legend class="text-sm font-black">PCR</legend>
                        <div class="mb-6 inline-block  lg:mx-5">
                            <Label for='den' class='block mb-2'>DENGUE</Label>
                ...
                <fieldset class="inline-block border-2 border-slate-400  rounded-lg p-2 shadow-md"><legend class="text-sm font-black">RAPID NS1</legend>


                    <div class="mb-6 inline-block  lg:mx-5">
                        <Label for='ns1_ag' class='block mb-2'>Ag</Label>
