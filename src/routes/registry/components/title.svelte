...
<div
class=" flex items-center justify-center h-15 w-15 rounded-lg bg-indigo-200 mx-0 "
>
...
<svg
    ...
    style="enable-background:new 0 0 55.835 55.835;"
    xml:space="preserve"
>
    <g>
        <path
            d="M55.288,39.943c-0.398-4.089-3.45-7.052-7.271-7.052c-2.396,0-4.407,1.448-5.684,3.212
...
c3.146,0,5.038,2.654,5.296,5.367C53.315,40.266,53.426,40.95,53.122,42.17z"
        />
        <path
            d="M27.501,12c-0.553,0-1,0.447-1,1s0.447,1,1,1h18c0.553,0,1-0.447,1-1s-0.447-1-1-1H27.501z"
        />
        <path
            d="M46.501,27c0-0.553-0.447-1-1-1h-18c-0.553,0-1,0.447-1,1s0.447,1,1,1h18C46.054,28,46.501,27.553,46.501,27z"
        />
        <path
            d="M21.08,7.241c-0.418-0.359-1.05-0.312-1.409,0.108l-6.248,7.288l-3.822-2.866c-0.44-0.33-1.068-0.243-1.399,0.2
...
C21.549,8.231,21.5,7.601,21.08,7.241z"
        />
        <path
            d="M21.08,21.241c-0.418-0.359-1.05-0.312-1.409,0.108l-6.248,7.288l-3.822-2.866c-0.44-0.33-1.068-0.243-1.399,0.2
c-0.332,0.441-0.242,1.068,0.2,1.399l4.571,3.429c0.179,0.135,0.39,0.2,0.599,0.2c0.283,0,0.563-0.119,0.76-0.35l6.857-8
C21.549,22.231,21.5,21.601,21.08,21.241z"
        />
        <path
            d="M19.671,36.35l-6.248,7.287l-3.822-2.866c-0.44-0.331-1.068-0.243-1.399,0.2c-0.332,0.441-0.242,1.068,0.2,1.399
...
C20.662,35.882,20.03,35.93,19.671,36.35z"
        />
        <path
            d="M25.501,52H12.677C7.066,52,2.501,47.436,2.501,41.824V12.176C2.501,6.564,7.066,2,12.677,2h29.648
...
<h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">
    New Order - {#if $step == 1}Patient Information {:else if $step == 2}Order Information {:else}Samples{/if}
</h3>
